...
public class DigiHealthCareGetProfileDataQuery {
	public static String SQL_PROFILEDATA ="select App_id,User_id,Account_type,First_name,Last_name,Phone_no,Email_id,Gender,DOB,Photo,Date,Address,Landmark,City,State,County,Zipcode,Lattitude,Longitude from Profile_table where User_id=?";
