...
public class DigihealthCareAdminCreateServiceQuery {
	...
	public static String SQL_PATIENT_INFO="insert into Profile_table (App_id,User_id,Account_type,First_name,Last_name,Phone_no,Password,Email_id,Gender,Photo,DOB,Date)"+"values(?,?,?,?,?,?,?,?,?,?,?,?)";     
